        ...
        <div class="product-card">
            ...
            <div>
                ...
                <div id="controls-${taco.nombre.replace(/\s/g, "")}" class="btn-wrap">
                    <button class="btn-primary flex-btn" onclick="agregarAlCarrito('${taco.nombre.replace(/'/g, "\\'")}')">Agregar al pedido</button>
                </div>
            </div>
        </div>`;
    });
        ...
        <div class="product-card">
            ...
            <div>
                ...
                <div id="controls-${bebida.nombre.replace(/\s/g, "")}" class="btn-wrap">
                    <button class="btn-primary flex-btn" onclick="agregarAlCarrito('${bebida.nombre.replace(/'/g, "\\'")}')">Agregar al pedido</button>
                </div>
            </div>
        </div>`;
    });
